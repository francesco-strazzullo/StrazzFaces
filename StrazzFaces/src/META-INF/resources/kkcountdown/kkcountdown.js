(function() {
  ...
  KKCountdown = (function() {
    ...
    KKCountdown.prototype.defaults = {
      ...
      warnClass: false,
      rusNumbers: false,
      boxContenerClass: 'countdown-box',
      boxDaysClass: 'countdown-days',
      boxHoursClass: 'countdown-hours',
      boxMinClass: 'countdown-min',
      boxSecClass: 'countdown-sec',
      boxDaysTextClass: 'countdown-days-text',
      boxHoursTextClass: 'countdown-hours-text',
      boxMinTextClass: 'countdown-min-text',
      boxSecTextClass: 'countdown-sec-text',
      theme: false,
      themeSize: 'default'
    };
    ...
    KKCountdown.prototype.countdownInit = function(obj) {
      ...
      _this = this;
      if (obj.id === void 0) {
        obj.id = 'countdown_' + Math.random(new Date().getTime());
      }
  ...
  $.fn.extend({
    kkcountdown: function(option) {
      return this.each(function() {
        ...
        if (!data) {
          $this.data('countdown', (data = new KKCountdown(this, option)));
        }
