...
public class CountDown extends UIInput implements Widget, ClientBehaviorHolder {
	...
	// Text displayed after certain number of days included in countdown (when
	// number days = 1)
	...
	public String getTextAfterCount() {
		return (String) getStateHelper().eval(PropertyKeys.textAfterCount,
				"Countdown complete!");
	}
	...
	protected static enum PropertyKeys {
		date, dayText, daysText, hoursText, minutesText, secondsText, oneDayClass, textAfterCount, displayDays, displayZeroDays, addClass, oncomplete, style, styleClass, widgetVar;
	}
}
